...
public class BlobStorageService(IOptions<BlobStorageSettings> blobStorageOptions) : IBlobStorageService
{
	...
	public string? GetBlobSasUrl(string? blobUrl)
	{
		...
		var sasToken = sasBuilder
			.ToSasQueryParameters(new Azure.Storage.StorageSharedKeyCredential(accountName: _blobStorageSettings.AccountName,
			accountKey: _blobStorageSettings.AccountKey))
			.ToString();
