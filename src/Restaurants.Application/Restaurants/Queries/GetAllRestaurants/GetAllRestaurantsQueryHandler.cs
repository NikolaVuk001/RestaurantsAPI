...
public class GetAllRestaurantsQueryHandler(ILogger<GetAllRestaurantsQueryHandler> logger,
	IMapper mapper, 
	IRestaurantRepository restaurantRepository) : IRequestHandler<GetAllRestaurantsQuery, PageResults<RestaurantDto>>
{
	public async Task<PageResults<RestaurantDto>> Handle(GetAllRestaurantsQuery request, CancellationToken cancellationToken)
	{
		...
		//var restaurantsDto = restaurants.Select(RestaurantDto.FromEntity); Manual Mapping
